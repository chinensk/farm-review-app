...
export default function ReviewPage() { 
  ...
  useEffect(() => { 
    const load = async () => { 
      ...
      setText((data?.q2 && data.q2.trim()) ? data.q2 : "粒が大きくて甘かったです。スタッフの方も親切でまた来たいです！"); 
    }; 
    load(); 
  }, [responseId]); 
  ...
  return ( 
    <div style={{ maxWidth: 560, margin: "0 auto", padding: 16 }}> 
      <h1 style={{ fontSize: 22, marginBottom: 8 }}>最後にお願いがあります</h1> 
      ...
      <div style={{ marginTop: 16, padding: 14, borderRadius: 12, border: "1px solid #eee" }}> 
        <div style={{ fontWeight: 800, marginBottom: 8 }}>投稿内容（編集は任意）</div> 
        <textarea 
          value={text} 
